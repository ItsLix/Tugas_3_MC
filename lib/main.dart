  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'Tambahkan Produk',
            style: TextStyle(fontWeight: FontWeight.w700, color: Color.fromARGB(255, 147, 47, 229)),
          ),
          centerTitle: true,
        ),
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    Text(
                      'Informasi Produk',
                      style: TextStyle(fontWeight: FontWeight.w800, fontSize: 18, color: Color.fromARGB(255, 66, 66, 66)),
                    ),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(border: Border.all(color: Color.fromARGB(223, 132, 132, 132), width: 1), borderRadius: BorderRadius.circular(10)),
                  child: FlatButton(
                    child: Icon(
                      Icons.add,
                ...
                child: Row(
                  children: [
                    Text(
                      ...
                      style: TextStyle(fontWeight: FontWeight.w500, fontSize: 13, color: Color.fromARGB(255, 66, 66, 66)),
                    )
                  ],
                ),
              ),
              Padding(
                padding: const EdgeInsets.only(right: 22, left: 22, top: 10, bottom: 100),
                child: Column(
                  children: [
                    TextField(
                      decoration: InputDecoration(
